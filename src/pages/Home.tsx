  ...
  const testimonials = [
    {
      name: 'Sarah Johnson',
      role: 'CTO, TechCorp',
      content: 'DevoSoft transformed our entire digital infrastructure. Their AI solutions increased our efficiency by 300%.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The team at DevoSoft is exceptional. They delivered our project on time and exceeded all expectations.',
      rating: 5,
      avatar: '/api/placeholder/64/64'
    },
    {
      ...
      content: 'Outstanding quality and innovative solutions. DevoSoft is our go-to partner for all tech projects.',
      rating: 5,
      avatar: '/api/placeholder/64/64'
    }
  ];
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 lg:px-8">
          <AnimatedSection animation="fade-in" className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              What Our <span className="bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">Clients Say</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Don't just take our word for it. Here's what industry leaders say about working with DevoSoft.
            </p>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <AnimatedSection key={testimonial.name}   delay={index * 200} duration={1200}>
