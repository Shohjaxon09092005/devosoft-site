        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <AnimatedSection animation="slide-up" delay={600}>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              We craft cutting-edge software solutions, AI-powered applications, and digital transformation strategies 
              that propel businesses into the future. Experience innovation like never before.
            </p>
          </AnimatedSection>

          <AnimatedSection animation="slide-up" delay={800}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button size="lg" className="bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 text-white px-8 py-3 text-base">
                Start Your Project
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button variant="outline" size="lg" className="border-2 hover:bg-muted/50 px-8 py-3 text-base">
